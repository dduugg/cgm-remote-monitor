  ...
  function create (docs, fn) {
    with_collection(function(err, collection) {
      ...
      docs.forEach(function(doc) {
        // TODO: update is deprecated and should be replaced
        // (see: http://mongodb.github.io/node-mongodb-native/2.0/api/Collection.html#update)
        // sometimes the call back assigns `created` parameter is invoked with a number (e.g. 1),
        // other times with an object (e.g. {"ok":1,"nModified":1,"n":1} )
